...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public bool __Gen_Delegate_Imp1(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task __Gen_Delegate_Imp33(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task<int> __Gen_Delegate_Imp34(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Set_Board_Manager))
			{
			    return new Set_Board_Manager(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Reset_Board))
			{
			    return new Reset_Board(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Reset_Board_UI))
			{
			    return new Reset_Board_UI(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Change_Player))
			{
			    return new Change_Player(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(Check_Put_Chess))
			{
			    return new Check_Put_Chess(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Put_Chess))
			{
			    return new Put_Chess(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(Show_Chess_UI))
			{
			    return new Show_Chess_UI(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(CheckWinner))
			{
			    return new CheckWinner(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(Get_Score))
			{
			    return new Get_Score(__Gen_Delegate_Imp4);
			}
		    ...
		    if (type == typeof(Add_Score))
			{
			    return new Add_Score(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(Update_Score_UI))
			{
			    return new Update_Score_UI(__Gen_Delegate_Imp5);
			}
